...
contract Task2 {
    ...
    */
    function getMessage() public view /* add something here */ returns (string memory) {
        // ✏️ YOUR CODE HERE
        return message;
    }
    ...
    Example: add(3,5) → 8
    */
    function add(uint a, uint b) public pure/* make this pure */ returns (uint) {
        // ✏️ YOUR CODE HERE
        return a+b;
    }
    ...
    */
    function isNumberBig() public view /* make this view */ returns (bool) {
        // ✏️ YOUR CODE HERE
        return number > 10;
    }
